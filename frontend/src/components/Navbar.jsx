...
const Navbar = () => {
  ...
  return (
    <nav
      className="bg-[#0a0d11]/80 backdrop-blur-xl sticky top-0 z-50 
    ...
    >
      ...
      */}
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-[1px] bg-[#68D391] transition-all duration-500 
      ...
      {/* MOBIL MENÜ */}
      <div
        className={`md:hidden overflow-hidden transition-all duration-300 ${isOpen ? "max-h-screen border-t border-white/5 bg-[#1a1f26]" : "max-h-0"}`}
      >
